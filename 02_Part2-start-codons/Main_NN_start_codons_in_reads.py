...
# script running LSTM model on start k-mers
...
#run model
tr_loss, ts_loss, pred, true, updated_model = mynn.run_network_binary(kmers_df.Embedding, kmers_df.Is_start_codon, model, epochs, optimizer, batch_size,loss_weights = loss_weights, nb_kmers = nb_kmers,tensorboard_log_dir = args.tensorboard, event_name =record, device = device, rdseed = seed)
